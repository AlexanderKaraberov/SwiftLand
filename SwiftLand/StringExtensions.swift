...
extension String {
    ...
    public func containsCharacters() -> Bool {
        
        let letters = NSCharacterSet.letterCharacterSet()
        return self.rangeOfCharacterFromSet(letters) != .None
    }
    
    ///Check if string contains decimal digits
    public func containsDigits() -> Bool {
        
        let digits = NSCharacterSet.decimalDigitCharacterSet()
        return self.rangeOfCharacterFromSet(digits) != .None
    }
